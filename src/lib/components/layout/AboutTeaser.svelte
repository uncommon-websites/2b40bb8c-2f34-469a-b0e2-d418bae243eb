...
<script lang="ts">
	...
	name: "Dario Amodei",
	role: "Co-founder & CEO",
	image: "/generated/image-a-professional-headshot-of-a-thoughtful-.webp"
};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"We started Anthropic because we believed AI should be built to serve humanity—not just push boundaries. Our goal is to align intelligence with our values, so every step forward is also a step toward safety and long-term benefit."`}
			/>
